...
//     "use strict";
    ...
    //     type: 'line',
    //     data: {
    //         labels: [ "T", "HC", "JS", "2015", "2016", "2017", "2018" ],
    //         type: 'line',
    //         defaultFontFamily: 'Montserrat',
    //         datasets: [ {
    //             label: "Electronics",
    ...
    // } );
                ...
                function (data)
                {
                    ...
                    var salesgraph = document.getElementById( "sales-chart" );
                    salesgraph.height = 200;

                    var lineGraph = new Chart(salesgraph, {
                        type: 'line',
                        defaultFontFamily: 'Montserrat',
                        data: chartdata,
                        options: {
    ...
    // } );
                ...
                function (data)
                {
                    ...
                    // var graphTarget = $("#singelBarChart");
                    var graphTarget = document.getElementById( "singelBarChart" );
